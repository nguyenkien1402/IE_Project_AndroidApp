...
public class ScheduleActivityAdapter extends ArrayAdapter<ActivityModelItem> implements View.OnClickListener {
    ...
    public ScheduleActivityAdapter(List<ActivityModelItem> datasets, Context context){
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(activitiesModel.getTitle().equals("Gym")){
            String dayHour = activitiesModel.getDayPerWeek() + " days, " + activitiesModel.getHours() +" hours for each";
            viewHolder.txtHour.setText(dayHour);
        }else{
